...
{
    [RoutePrefix("api/ScheduleExam")]
    [Route("api/ScheduleExam")]
    public class ScheduleExamController : ApiController
    {
        private readonly IExamScheduleService _service;

        public ScheduleExamController(IExamScheduleService service)
        {
            _service = service;
        }
        ...
        [Route("")]
        [HttpPost]
        public HttpResponseMessage Post([FromBody] ExamSchedule entity)
        {
            HttpResponseMessage response;
        ...
        [Route("")]
        [HttpPut]
        public HttpResponseMessage Put([FromBody] ExamSchedule entity)
        {
            HttpResponseMessage response;
        ...
        [Route("")]
        [HttpDelete]
        public HttpResponseMessage Delete([FromBody] ExamSchedule entity)
        {
            HttpResponseMessage response;
